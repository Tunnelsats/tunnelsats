  ...
  return (
    ...
    >
      ...
      <InputGroup className="mb-3">
       ...
       <Button variant="outline-warning" onClick={() => { navigator.clipboard.writeText(props.value) } }>Copy</Button>
      </InputGroup>
      ...
      <Modal.Footer>
	      <Button variant="outline-warning" onClick={props.handleClose}>OK</Button>
