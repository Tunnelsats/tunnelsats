...
PostUp = nft add chain ip %i mangle '{type route hook output priority mangle -1 ; policy accept;}'; nft add rule ip %i mangle meta mark != 0x3333 meta cgroup 1118498 meta mark set 0xdeadbeef\n
